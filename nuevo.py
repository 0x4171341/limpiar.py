...
if 'creador' in sys.argv:
   ...
   print("""
1-Cuando escribimos cosas en la terminal,eso deja obviamente huellas,y es un dato importante
...
creador:python3 nuevo.py creador
introducion python3 nuevo.py introduccion
